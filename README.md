...
| 5.   | void dappf::meta::event_listeners::[**on_packet_sent**](https://github.com/zydee3/DAPPF/blob/master/framework/meta/event_listeners.cpp)([dappf::meta::packet_reader](https://github.com/zydee3/DAPPF/blob/master/framework/meta/packet_reader.h));<br /><br />Called when a packet is sent to current established neighbors. The given packet_writer parameter provides an interface for writing bytes sequentially in a safe and efficient way. See [dappf::meta::packet_writer](https://github.com/zydee3/DAPPF/blob/master/framework/meta/packet_reader.h) for further documentation. The packet writer in this state is immutable. | 
