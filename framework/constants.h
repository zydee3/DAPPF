...
namespace dappf::constants {
    ...
    static const int num_bytes_ipv4_address = 4;
    ...
    static const int num_bytes_header = num_bytes_ipv4_address + num_bytes_port + num_bytes_message_id + num_bytes_op_code + num_bytes_compression_flag;
    static const int pos_compression_flag = num_bytes_header - num_bytes_compression_flag;
}
