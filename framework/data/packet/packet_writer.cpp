...
void dappf::meta::packet::packet_writer::encode_address(std::string address){
...
void dappf::meta::packet::packet_writer::encode_port(int16_t port){
    packet->at(dappf::constants::pos_port - 1) = (int8_t) (port);
    packet->at(dappf::constants::pos_port) = (int8_t) (port >> 8);
}

void dappf::meta::packet::packet_writer::encode_message_id(int64_t message_id){
...
void dappf::meta::packet::packet_writer::encode_op_code(int16_t op_code){
    packet->at(dappf::constants::pos_op_code - 1) = (int8_t) (op_code);
    packet->at(dappf::constants::pos_op_code) = (int8_t) (op_code >> 8);
}

void dappf::meta::packet::packet_writer::encode_compression_flag(bool is_compressed){
